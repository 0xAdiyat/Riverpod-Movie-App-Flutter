...
class ProfilesData {
  ...
  factory ProfilesData.fromMap(Map<String, dynamic> map) {
    ...
    final profiles = profilesMap.map((key, value) =>
        MapEntry<String, Profile>(key, Profile.fromJson(value)));
    return ProfilesData(profiles: profiles, selectedId: map['selectedId']);
  }

  Map<String, dynamic> toMap() =>
      {'profiles': profiles, 'selectedId': selectedId};
  ...
  ProfilesData copyWith({Map<String, Profile>? profiles, String? selectedId}) =>
      ProfilesData(
